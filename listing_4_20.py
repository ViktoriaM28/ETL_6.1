...
# Define constants
RUSSIAN_SITES = {"Sberbank","Sberbank.ru","Sberbank.com"}
...
dag = DAG(
    ...
    schedule_interval="0 14 * * *",  # Run daily at 12:00 UTC
...
def _get_data(year, month, day, output_path):
    url = (
        ...
        f"{year}/{year}-{month:0>2}/pageviews-{year}{month:0>2}{day:0>2}-140000.gz"
    )
    try:
